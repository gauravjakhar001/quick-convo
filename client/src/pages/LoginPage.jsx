...
const LoginPage = () => {
  ...
  const [currState,setCuurState] =useState("Sign up")
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg' >
      <h2 className='font-medium text-2xl flex justify-between items-center'>
        ...
        <button  type='submit' className='py-3  bg-gradient-to-r from bg-purple-400 to via-violet-600 text-white rounded-md cursor-pointer'>
        ...
        <div className='flex flex-col gap-2'>
          {currState === "Sign up" ? (
            ...
            <p className='text-sm text-gray-600'>Create an Account <span onClick={()=>setCuurState("Sign up")} className='font-medium text-violet-500 cursor-pointer'>Click here</span></p>
          )}
